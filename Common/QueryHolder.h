...
typedef std::shared_ptr<SQLQueryHolder> QueryHolder;

typedef std::future<QueryHolder> QueryResultHolderFuture;
typedef std::promise<QueryHolder> QueryResultHolderPromise;

class SQLQueryHolderTask : public SQLOperation
{
    private:
        QueryHolder m_holder;
